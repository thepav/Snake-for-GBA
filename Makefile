...
OFILES = main.o mylib.o shell.o heart.o numbers.o gameover.o startscreen.o ball.o winscreen.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h shell.h heart.h numbers.h gameover.h main.h startscreen.h ball.h winscreen.h
